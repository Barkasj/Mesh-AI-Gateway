...
const docSections = [
	{
		...
		icon: Play,
		url: "https://github.com/mesh-ai-gateway/mesh-ai-gateway/tree/main/docs/quickstart",
		badge: "Popular",
	...
	},
	{
		...
		icon: GitBranch,
		url: "https://github.com/mesh-ai-gateway/mesh-ai-gateway/tree/main/docs/architecture",
	...
	},
	{
		...
		icon: BookOpen,
		url: "https://github.com/mesh-ai-gateway/mesh-ai-gateway/tree/main/docs/usage",
		badge: "Comprehensive",
	...
	},
	{
		...
		icon: Users,
		url: "https://github.com/mesh-ai-gateway/mesh-ai-gateway/tree/main/docs/contributing",
	...
	},
	{
		...
		icon: Code,
		url: "https://github.com/mesh-ai-gateway/mesh-ai-gateway/tree/main/docs/usage/http-transport/integrations",
	...
	},
	{
		...
		icon: Zap,
		url: "https://github.com/mesh-ai-gateway/mesh-ai-gateway/blob/main/docs/benchmarks.md",
...
const featuredDocs = [
	{
		...
		href: "https://github.com/mesh-ai-gateway/mesh-ai-gateway/blob/main/docs/mcp.md",
		icon: FileText,
	...
	},
	{
		...
		href: "https://github.com/mesh-ai-gateway/mesh-ai-gateway/blob/main/docs/governance.md",
		icon: Shield,
				...
				<div className="space-y-8">
					...
					<div className="space-y-4 text-center">
						...
						<div className="flex justify-center gap-4">
							<Button asChild>
								<Link href="https://github.com/mesh-ai-gateway/mesh-ai-gateway/tree/main/docs" target="_blank">
									<ExternalLink className="mr-2 h-4 w-4" />
									View Full Documentation
								</Link>
							</Button>
							<Button variant="outline" asChild>
								<Link href="https://github.com/mesh-ai-gateway/mesh-ai-gateway/tree/main/docs/quickstart" target="_blank">
