...
const externalLinks = [
	...
	{
		title: "Report a bug",
		url: "https://github.com/mesh-ai-gateway/mesh-ai-gateway/issues/new?labels=bug&title=%5BBug%20Report%5D",
		icon: BugIcon,
		strokeWidth: 1.5,
	},
	{
...
export default function AppSidebar() {
	...
	const items = useMemo(
		() => [
			...
			{
				title: "Evals",
				url: "https://github.com/mesh-ai-gateway/mesh-ai-gateway/discussions",
				icon: FlaskConical,
				isExternal: true,
			...
			cards.push({
				...
				description: (
					<div className="flex h-full flex-col gap-2">
						...
						<Link
							href={`https://docs.mesh-ai-gateway.io/changelogs/${latestRelease.name}`}
							target="_blank"
