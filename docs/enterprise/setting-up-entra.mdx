...
<Tip>
You can add an app icon to make the application easily recognizable. The Bifrost logo is available at: [https://docs.mesh-ai-gateway.io/media/bifrost-logo.png](https://docs.mesh-ai-gateway.io/media/bifrost-logo.png)
</Tip>
