...
- **Logo** (optional): You can upload the Bifrost logo from [https://docs.mesh-ai-gateway.io/media/bifrost-logo.png](https://docs.mesh-ai-gateway.io/media/bifrost-logo.png)
...
<Frame>
  <img src="/media/user-provisioning/okta-group-claim-mapping.png" alt="Group-to-Role Mappings configuration in Bifrost" />
</Frame>
