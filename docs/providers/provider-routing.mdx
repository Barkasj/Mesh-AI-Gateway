...
1. **Pricing Data** (Primary source)
   - Downloaded from a remote URL (configurable, defaults to `https://pricing.mesh-ai-gateway.io/datasheet`)
...
<Info>
**Enterprise Feature**: Adaptive Load Balancing is available in Bifrost Enterprise. [Contact us](https://github.com/mesh-ai-gateway/mesh-ai-gateway/discussions) to enable it.
</Info>
